...
class Descriptor :
    ...
    def __init__ (self,args_lista, sujeto, posicion, tiempo, estado, chrInit=256) :
    ...
    def escribir(self, literal):
        if '-' in literal:
            ...
            atomo = literal
            neg = ''
        x, y, o, e = self.inv(atomo)
        if e == 0:
           return self.sujeto[x] + neg + " está en " + self.posicion[y] + " el " + self.tiempo[o]
        else:
           return self.sujeto[x] + neg + " viaja a " + self.posicion[y] + " el " + self.tiempo[o]
